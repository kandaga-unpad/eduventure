	...
	<div class="text-center">
		...
		<div class="my-10 px-3">
			...
			<div class="w-full my-10">
				{#if data.eduventureHoliyeay.length === 0}
					<h5>Anda belum membeli Tiket Eduventure Holiyeay</h5>
				{:else}
					<h5>Eduventure Holiyeay</h5>
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
						{#each data.eduventureHoliyeay as tiket, i}
							<div class="bg-yellow-50 shadow-2xl w-full text-sm">
								<h4 class="bg-brand-primary text-white py-2 rounded">
									Tiket {data.eduventureHoliyeay.length > 1 ? `${i + 1}` : 'Anda'}
								</h4>
								...
								<div class="w-full flex items-center justify-center gap-5 p-5">
									...
									{:else if tiket.status_pendaftaran === 'paid'}
										<a
											href="/profile/tiket/holiyeay/{tiket.id}"
				...
				{:else}
					<h5 class="mb-5">Tiket untuk kegiatan Eduventure mendatang</h5>
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
					...
					<h5 class="mt-15 mb-5">Tiket Eduventure yang lampau</h5>
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
						{#each data.historicalTiket as tiket, i}
							<div class="bg-yellow-50 shadow-2xl w-full text-sm">
								<h4 class="bg-brand-primary text-white py-2 rounded">
									Tiket {data.tagihan.length > 1 ? `${i + 1}` : 'Anda'}
								</h4>
								...
								<div class="w-full flex items-center justify-center gap-5 p-5">
									<button class="btn bg-gray-3 text-dark w-full cursor-not-allowed" disabled>
										Tiket ini tidak bisa digunakan
									</button>
								</div>
							</div>
						{/each}
