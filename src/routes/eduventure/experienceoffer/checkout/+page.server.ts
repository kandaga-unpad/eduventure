...
export const actions: Actions = {
  beli: async ({ request, fetch, locals }) => {
    ...
    const orderId = `special-offer-eduventure-${Math.random().toString(36).substring(2, 15)}`
    ...
    const transactionDetails = {
      ...
      "item_details": [{
        ...
        "price": 315000,
        "quantity": 1,
        "name": "Eduventure Experience - Special Offer",
    ...
    await redirect(303, '/eduventure/experienceoffer/pembayaran/' + orderId)
  }
};